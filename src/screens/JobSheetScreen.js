...
// ── DATA JADWAL STATIS UNTUK DITAMPILKAN ─────────────────────────────
...
export default function JobSheetScreen({ navigation }) {
  const [activeTab, setActiveTab] = useState('jobsheet'); // 'jobsheet' or 'jadwal'
  ...
  // ════════════════════════════════════════════════════════════
  //  REALTIME LISTENER — Memuat Modul dari Firestore
  // ════════════════════════════════════════════════════════════
  useEffect(() => {
  ...
  // ════════════════════════════════════════════════════════════
  //  HANDLE SUBMIT — Menyimpan Modul Baru
  // ════════════════════════════════════════════════════════════
  ...
  // ════════════════════════════════════════════════════════════
  //  HANDLE LOGOUT — Keluar dari Aplikasi
  // ════════════════════════════════════════════════════════════
  const handleLogout = () => {
    ...
    if (Platform.OS === 'web') {
      if (window.confirm(msg)) {
        signOut(auth)
          .then(() => navigation.replace('Login')) // Kembali ke LoginScreen
      ...
      Alert.alert('Konfirmasi Logout', msg, [
        ...
        { 
          ...
          onPress: async () => {
            try {
              await signOut(auth);
              navigation.replace('Login'); // Kembali ke LoginScreen
            } catch (err) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        {/* Baris Profil + Tombol Logout di Sebelah Kanan */}
      ...
      {activeTab === 'jobsheet' ? (
        ...
        /* ═══ HALAMAN JADWAL KULIAH (SUDAH DIPERBAIKI) ═════════════════════════ */
        <View style={styles.content}>
